...
OUTPUT_FILE = Path(__file__).parent / "gemini_responses.txt"
PROMPT = """
The Updated Prompt
Role: You are an expert Telugu Pandit and Maha Kavi (Great Poet) with deep knowledge of Telugu Chandassu (Prosody), specifically the Dwipada meter.
